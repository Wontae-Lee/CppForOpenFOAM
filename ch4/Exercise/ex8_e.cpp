...
template <typename T, unsigned Dim>
Vector<T, Dim> operator+(Vector<T, Dim> &a, Vector<T, Dim> &b);

template <typename T, unsigned Dim>
Vector<T, Dim> operator*(const double &c, Vector<T, Dim> &v);

template <typename T, unsigned Dim>
Vector<T, Dim> operator*(Vector<T, Dim> &v, const double &c);
